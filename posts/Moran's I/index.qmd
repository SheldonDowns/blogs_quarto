...
date: "2026-07-14"
categories: [code, analysis, spatial statistics]
...
verify that the data actually has spatial structure which means that nearby locations tend 
...
**inverse distance weights** which means that closer sensor pairs get more influence than 
